...
{
    "distutils": {
        "name": "JigUnloading_Zone2.models",
        "sources": [
            ".\\JigUnloading_Zone2\\models.py"
        ]
    },
    "module_name": "JigUnloading_Zone2.models"
}
END: Cython Metadata */
...
#define __PYX_HAVE__JigUnloading_Zone2__models
#define __PYX_HAVE_API__JigUnloading_Zone2__models
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "JigUnloading_Zone2.models" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "JigUnloading_Zone2.models"
extern int __pyx_module_is_main_JigUnloading_Zone2__models;
int __pyx_module_is_main_JigUnloading_Zone2__models = 0;

/* Implementation of "JigUnloading_Zone2.models" */
...
__Pyx_RefNannySetupContext("PyInit_models", 0);
  ...
  if (__pyx_module_is_main_JigUnloading_Zone2__models) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "JigUnloading_Zone2.models")) {
      if (unlikely((PyDict_SetItemString(modules, "JigUnloading_Zone2.models", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "JigUnloading_Zone2/models.py":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init JigUnloading_Zone2.models", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init JigUnloading_Zone2.models");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
