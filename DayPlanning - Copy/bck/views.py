...
class TrayIdUniqueCheckAPIView(APIView):
    ...
    def get(self, request):
        ...
        if not existing_tray:
            # ✅ Check if tray exists in DraftTrayId
            ...
            if draft_tray and draft_tray.batch_id:
                return JsonResponse({
                    ...
                    'available': True,
                    'in_draft': True,
                    'batch_id': draft_tray.batch_id.batch_id,
                    'message': 'Tray found in draft'
                })
        ...
        if existing_tray.scanned:
            return JsonResponse({
                ...
                'batch_id': existing_tray.batch_id.batch_id if existing_tray.batch_id else None,  # ✅ ADD batch_id
