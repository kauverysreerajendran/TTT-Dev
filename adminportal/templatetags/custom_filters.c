...
{
    "distutils": {
        "name": "adminportal.templatetags.custom_filters",
        "sources": [
            ".\\adminportal\\templatetags\\custom_filters.py"
        ]
    },
    "module_name": "adminportal.templatetags.custom_filters"
}
END: Cython Metadata */
...
#define __PYX_HAVE__adminportal__templatetags__custom_filters
#define __PYX_HAVE_API__adminportal__templatetags__custom_filters
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
static const char* const __pyx_f[] = {
  "adminportal/templatetags/custom_filters.py",
};
...
/* Module declarations from "adminportal.templatetags.custom_filters" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "adminportal.templatetags.custom_filters"
extern int __pyx_module_is_main_adminportal__templatetags__custom_filters;
int __pyx_module_is_main_adminportal__templatetags__custom_filters = 0;

/* Implementation of "adminportal.templatetags.custom_filters" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_11adminportal_12templatetags_14custom_filters_get_item(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_dictionary, PyObject *__pyx_v_key); /* proto */
...
#define __pyx_kp_u_adminportal_templatetags_custom_2 __pyx_string_tab[3]
#define __pyx_n_u_Library __pyx_string_tab[4]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[5]
#define __pyx_n_u_adminportal_templatetags_custom __pyx_string_tab[6]
...
#define __pyx_n_u_django __pyx_string_tab[10]
...
#define __pyx_n_u_get_item __pyx_string_tab[14]
...
/* "adminportal/templatetags/custom_filters.py":4
...
/* Python wrapper */
static PyObject *__pyx_pw_11adminportal_12templatetags_14custom_filters_1get_item(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_11adminportal_12templatetags_14custom_filters_1get_item = {"get_item", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_11adminportal_12templatetags_14custom_filters_1get_item, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_11adminportal_12templatetags_14custom_filters_1get_item(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "get_item", 0) < (0)) __PYX_ERR(0, 4, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("get_item", 1, 2, 2, i); __PYX_ERR(0, 4, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("get_item", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 4, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("adminportal.templatetags.custom_filters.get_item", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11adminportal_12templatetags_14custom_filters_get_item(__pyx_self, __pyx_v_dictionary, __pyx_v_key);
...
static PyObject *__pyx_pf_11adminportal_12templatetags_14custom_filters_get_item(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_dictionary, PyObject *__pyx_v_key) {
  ...
  /* "adminportal/templatetags/custom_filters.py":6
 * @register.filter
 * def get_item(dictionary, key):
 *     return dictionary.get(key, "")             # <<<<<<<<<<<<<<
 * 
*/
  ...
  __pyx_t_3 = 0;
  {
    PyObject *__pyx_callargs[3] = {__pyx_t_2, __pyx_v_key, __pyx_mstate_global->__pyx_kp_u_};
...
static int __pyx_pymod_exec_custom_filters(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_custom_filters},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_custom_filters(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_custom_filters(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_custom_filters(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'custom_filters' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "custom_filters" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_custom_filters", 0);
  ...
  if (__pyx_module_is_main_adminportal__templatetags__custom_filters) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "adminportal.templatetags.custom_filters")) {
      if (unlikely((PyDict_SetItemString(modules, "adminportal.templatetags.custom_filters", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "adminportal/templatetags/custom_filters.py":1
...
*/
  ...
  /* "adminportal/templatetags/custom_filters.py":2
 * from django import template
 * register = template.Library()             # <<<<<<<<<<<<<<
 * 
 * @register.filter
*/
  __pyx_t_4 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_template); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_Library); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 2, __pyx_L1_error)
  ...
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_register, __pyx_t_2) < (0)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  __pyx_t_6 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_register); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_filter); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_CyFunction_New(&__pyx_mdef_11adminportal_12templatetags_14custom_filters_1get_item, 0, __pyx_mstate_global->__pyx_n_u_get_item, NULL, __pyx_mstate_global->__pyx_n_u_adminportal_templatetags_custom, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  ...
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_get_item, __pyx_t_2) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init adminportal.templatetags.custom_filters", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init adminportal.templatetags.custom_filters");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{0},{1},{1},{42},{7},{20},{39},{18},{18},{10},{6},{6},{8},{3},{8},{13},{5},{3},{8},{10},{8},{3},{12},{8},{12},{10},{8},{8},{6},{15}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (272 bytes) */
const char* const cstring = "BZh91AY&SY\202}G\371\000\000\003\377\341d\010 \000\002\001\200\020\204\005T\000\277\277\377`@@@@@\0000\000\302CS\324\001S\3155'\350\215\020\007\352\201\351\346\252\r#CMS\322~\246\220b\r\000\000\030hd4\311\240\030\206\232h\320\321\234\207\010\344\037V\374\037$\342\230\031+\204XZ-M#\213^\316e\313H\214\356$\032\266\260\220\251\027\375\376\373<@\214$\225\211/=\225\341<;\271/\2477\013/D\332#\264\352\247\347\323\276*\327(\002y\245X\n\357M\206\233*\005\222\344/}7Sa\254\206\243U\266\206\305\215To-\020<H\337p\232\231(\357\000\020=\244\223\302D\256+Z\320l\301\302\361\231\n\232\206=\016\341N\0071\000\340\301\250\346|d,|*\020\370\327Y\200\241\321I\323\321\233D\211\300G1\223\303\237c\274z\300TC|\261\326\2543i\343\t\204O\361w$S\205\t\010'\324\177\220";
    PyObject *data = __Pyx_DecompressString(cstring, 272, 2);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (214 bytes) */
const char* const cstring = "x\332U\217;N\003A\014@\205\224\216*\207H;\351i\322PF\010!z\313\231\361\256L\346\227\261\007e;JJ\312=\036G\301\311\n\024,\377%?\333n\207!q\256\245)\306\255R\252\021\225\024G\331\372.Z\022\014\034\225\232\270:\355\371\320\260M\000\317\323\331\354\221\275\302\023\235\365\205\206\033\210\273\205\270\377\020\224){.\316\227V\272r&\361\321<p\006m\350\351\200\376\030\014\313%\333\242\360\206y,\313(\300\320\263\007\030IM\201m\t\260\300\037\350\322\220#\331q\t\215f\222J\350\221.Y\306d\261\226\np\352\030\227\262\321\310r\005\213\361\226\236e\301~\351Q\177\177\000P\022\005x\307\330I>\356\276W\367\237\017_\257\363z\336\314\247\037\004e\177\347";
    ...
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (316 bytes) */
const char* const bytes = ".?adminportal/templatetags/custom_filters.pyLibrary__Pyx_PyDict_NextRefadminportal.templatetags.custom_filtersasyncio.coroutinescline_in_tracebackdictionarydjangofilter__func__getget_item_is_coroutineitemskey__main____module____name__pop__qualname__register__set_name__setdefaulttemplate__test__values\200\001\340\004\013\210:\220T\230\021\230%\230q";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_adminportal_templatetags_custom_2, __pyx_mstate->__pyx_n_u_get_item, __pyx_mstate->__pyx_kp_b_iso88591_T_q, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
