...
{
    "distutils": {
        "name": "BrassAudit.apps",
        "sources": [
            ".\\BrassAudit\\apps.py"
        ]
    },
    "module_name": "BrassAudit.apps"
}
END: Cython Metadata */
...
#define __PYX_HAVE__BrassAudit__apps
#define __PYX_HAVE_API__BrassAudit__apps
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "BrassAudit.apps" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "BrassAudit.apps"
extern int __pyx_module_is_main_BrassAudit__apps;
int __pyx_module_is_main_BrassAudit__apps = 0;

/* Implementation of "BrassAudit.apps" */
...
#define __pyx_n_u_BrassAudit __pyx_string_tab[4]
#define __pyx_n_u_BrassAudit_apps __pyx_string_tab[5]
#define __pyx_n_u_BrassQcConfig __pyx_string_tab[6]
...
__Pyx_RefNannySetupContext("PyInit_apps", 0);
  ...
  if (__pyx_module_is_main_BrassAudit__apps) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "BrassAudit.apps")) {
      if (unlikely((PyDict_SetItemString(modules, "BrassAudit.apps", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  __pyx_t_6 = __Pyx_Py3MetaclassPrepare(__pyx_t_5, __pyx_t_2, __pyx_mstate_global->__pyx_n_u_BrassQcConfig, __pyx_mstate_global->__pyx_n_u_BrassQcConfig, (PyObject *) NULL, __pyx_mstate_global->__pyx_n_u_BrassAudit_apps, (PyObject *) NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 4, __pyx_L1_error)
...
*/
  ...
  /* "BrassAudit/apps.py":6
 * class BrassQcConfig(AppConfig):
 *     default_auto_field = 'django.db.models.BigAutoField'
 *     name = 'BrassAudit'             # <<<<<<<<<<<<<<
*/
  if (__Pyx_SetNameInClass(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_name_2, __pyx_mstate_global->__pyx_n_u_BrassAudit) < (0)) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 *     name = 'BrassAudit'
*/
  __pyx_t_4 = __Pyx_Py3ClassCreate(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_BrassQcConfig, __pyx_t_2, __pyx_t_6, NULL, 0, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_4);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_BrassQcConfig, __pyx_t_4) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init BrassAudit.apps", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init BrassAudit.apps");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{29},{9},{10},{15},{13},{18},{18},{11},{7},{8},{13},{10},{15},{8},{4},{11},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (194 bytes) */
const char* const cstring = "BZh91AY&SY\320B?\274\000\000\003_\200@\000\000\001\000\000\271\000 \000\277\277\376\0000\000\265\266\032(4\3650OSCG\251\201(\232i6\250z\236\243j0\236\220J\232j='\25044\320\002\250\237\263\301j]\315Z\222n}\325\241\004\242\211>g\205UTq\3504\201\363\341\337\337Ra1$+0\2072\373\206.\222\006\266r\207\326:m:\025<A`h\354\343.(3\215\004=\253\371\022\262\236A3\003X\262\251\332\301*\204\304wZ\014W\351\213\255\260d\343L\301i\236c\010\363h\276\304\324\355(\320\033\320\364\030}C\255\346\025\343#\300\273\222)\302\204\206\202\021\375\340";
    PyObject *data = __Pyx_DecompressString(cstring, 194, 2);
...
const char* const cstring = "x\332EMI\016\3020\014\374Q\276\200Z$\356\274\300rc\2672\270qH\234\377\223\246T\3700\336f\t7za\332,\320\022v#\326\032f\331\246\346\366\020V\232r\276[Ze\233\013\326:5\022\377O\001s\256c}\306\223\025U\022\203$\360\202\221\027\214o\342\025\233:`w\204\365\260\374\345\035Z\000\262\010\275v\354\232\243\263c\324n8\026\243\246<\246b\300\311\213\360x$\334\371\302\\8c\031\254OC=\217\225\375\312\005\347\332\361\013\223\377[\022";
    ...
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (231 bytes) */
const char* const bytes = ".?django.db.models.BigAutoFieldAppConfigBrassAuditBrassAudit.appsBrassQcConfigcline_in_tracebackdefault_auto_fielddjango.apps__doc____main____metaclass____module____mro_entries____name__name__prepare____qualname__setdefault__test__";
    PyObject *data = NULL;
