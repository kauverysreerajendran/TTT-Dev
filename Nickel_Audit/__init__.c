...
{
    "distutils": {
        "name": "Nickel_Audit.__init__",
        "sources": [
            ".\\Nickel_Audit\\__init__.py"
        ]
    },
    "module_name": "Nickel_Audit.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__Nickel_Audit
#define __PYX_HAVE_API__Nickel_Audit
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "Nickel_Audit" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "Nickel_Audit.__init__"
extern int __pyx_module_is_main_Nickel_Audit____init__;
int __pyx_module_is_main_Nickel_Audit____init__ = 0;

/* Implementation of "Nickel_Audit" */
...
#define __pyx_kp_u_Nickel_Audit___init __pyx_string_tab[1]
...
static int __pyx_pymod_exec_Nickel_Audit(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_Nickel_Audit},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_Nickel_Audit(void) CYTHON_SMALL_CODE; /*proto*/
#if !defined(CYTHON_NO_PYINIT_EXPORT) && (defined(_WIN32) || defined(WIN32) || defined(MS_WINDOWS))
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_Nickel_Audit(); }
#endif
__Pyx_PyMODINIT_FUNC PyInit_Nickel_Audit(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_Nickel_Audit(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'Nickel_Audit' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "Nickel_Audit" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_Nickel_Audit", 0);
  ...
  if (__pyx_module_is_main_Nickel_Audit____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_Nickel_Audit___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Nickel_Audit")) {
      if (unlikely((PyDict_SetItemString(modules, "Nickel_Audit", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init Nickel_Audit", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init Nickel_Audit");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{21},{18},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (82 bytes) */
const char* const cstring = "x\332%\214\301\r\2000\014\0037b\005\304\002\254`\2054HQ\323V\320d\177\002\370q>\177\274\356\312U\014[\024\365\005\320\256\016\260i\227t\370M,\007q\005\032\345\316\264Q\302\344\265N\355\353+\310~\237\342EN\n\313\017\227\231|\000\031u&\007";
    ...
    #endif
    #else /* compression: none (96 bytes) */
const char* const bytes = "?Nickel_Audit.__init__cline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
