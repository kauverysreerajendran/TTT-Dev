...
{
    "distutils": {
        "name": "Nickel_Audit.apps",
        "sources": [
            ".\\Nickel_Audit\\apps.py"
        ]
    },
    "module_name": "Nickel_Audit.apps"
}
END: Cython Metadata */
...
#define __PYX_HAVE__Nickel_Audit__apps
#define __PYX_HAVE_API__Nickel_Audit__apps
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "Nickel_Audit.apps" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "Nickel_Audit.apps"
extern int __pyx_module_is_main_Nickel_Audit__apps;
int __pyx_module_is_main_Nickel_Audit__apps = 0;

/* Implementation of "Nickel_Audit.apps" */
...
#define __pyx_n_u_NickelAuditConfig __pyx_string_tab[4]
#define __pyx_n_u_Nickel_Audit __pyx_string_tab[5]
#define __pyx_n_u_Nickel_Audit_apps __pyx_string_tab[6]
...
__Pyx_RefNannySetupContext("PyInit_apps", 0);
  ...
  if (__pyx_module_is_main_Nickel_Audit__apps) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Nickel_Audit.apps")) {
      if (unlikely((PyDict_SetItemString(modules, "Nickel_Audit.apps", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  __pyx_t_6 = __Pyx_Py3MetaclassPrepare(__pyx_t_5, __pyx_t_2, __pyx_mstate_global->__pyx_n_u_NickelAuditConfig, __pyx_mstate_global->__pyx_n_u_NickelAuditConfig, (PyObject *) NULL, __pyx_mstate_global->__pyx_n_u_Nickel_Audit_apps, (PyObject *) NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 4, __pyx_L1_error)
...
*/
  ...
  /* "Nickel_Audit/apps.py":6
 * class NickelAuditConfig(AppConfig):
 *     default_auto_field = 'django.db.models.BigAutoField'
 *     name = 'Nickel_Audit'             # <<<<<<<<<<<<<<
*/
  if (__Pyx_SetNameInClass(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_name_2, __pyx_mstate_global->__pyx_n_u_Nickel_Audit) < (0)) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 *     name = 'Nickel_Audit'
*/
  __pyx_t_4 = __Pyx_Py3ClassCreate(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_NickelAuditConfig, __pyx_t_2, __pyx_t_6, NULL, 0, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_4);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_NickelAuditConfig, __pyx_t_4) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init Nickel_Audit.apps", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init Nickel_Audit.apps");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{29},{9},{17},{12},{17},{18},{18},{11},{7},{8},{13},{10},{15},{8},{4},{11},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (198 bytes) */
const char* const cstring = "BZh91AY&SY\314\036\335\004\000\000\003_\200@\000\000\001\000\000\271\001\000\000\277\277\376\0000\000\272\266\032(i\223\324f\246@m\001\252z\236\203(f\240\365\001\220b)\265O\3254\323OQ\3512zi$\236x\302\363\036\243ul\2573\223*\023\001\002\350\037\227\361\262I\032\nHv\001\326\216\255w\023\005\013*\215\347\031T1\034\340\206\266z\222{\306\217\352\205N\340\020\2247~\317\244\353Q\031\210(`\342\331\362\303i\256\244T\r\nB\315\016\342\356W\322\014\tT\334H'\241\330\250\342\303\311\331E *\260<R\275\254BL\333\010\310f\0350\177^$\2502<\013\271\"\234(Hf\017n\202\000";
    ...
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (148 bytes) */
const char* const cstring = "x\332MMA\016\3030\010\373Q\2760u\223v\334\027\020\r\264b\245!K\310\377\227f\253T\016\006\214\261\303\215\336\230V\0134\207\335\210\265\206\273\254Ss{\n+M9?,-\262\276$n\254S#\361+\001\203\271\316\001s\256Q%1H\002/\030y\306\270\021/\330\324\001\2733,\207\365?\367\220\003\220E\350\265c\3779:;F\305Z\307b\324\224\307T\0148y\021\036\207\204;\237\230\013g,C\365i\250?\262\262\237\271\340\\;~\001b\261^$";
    PyObject *data = __Pyx_DecompressString(cstring, 148, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
...
const char* const bytes = ".?django.db.models.BigAutoFieldAppConfigNickelAuditConfigNickel_AuditNickel_Audit.appscline_in_tracebackdefault_auto_fielddjango.apps__doc____main____metaclass____module____mro_entries____name__name__prepare____qualname__setdefault__test__";
    PyObject *data = NULL;
