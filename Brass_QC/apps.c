...
#define __PYX_HAVE__Brass_QC__apps
#define __PYX_HAVE_API__Brass_QC__apps
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "Brass_QC.apps" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "Brass_QC.apps"
extern int __pyx_module_is_main_Brass_QC__apps;
int __pyx_module_is_main_Brass_QC__apps = 0;

/* Implementation of "Brass_QC.apps" */
...
#define __pyx_n_u_BrassQcConfig __pyx_string_tab[4]
#define __pyx_n_u_Brass_QC __pyx_string_tab[5]
#define __pyx_n_u_Brass_QC_apps __pyx_string_tab[6]
...
__Pyx_RefNannySetupContext("PyInit_apps", 0);
  ...
  if (__pyx_module_is_main_Brass_QC__apps) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Brass_QC.apps")) {
      if (unlikely((PyDict_SetItemString(modules, "Brass_QC.apps", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  __pyx_t_6 = __Pyx_Py3MetaclassPrepare(__pyx_t_5, __pyx_t_2, __pyx_mstate_global->__pyx_n_u_BrassQcConfig, __pyx_mstate_global->__pyx_n_u_BrassQcConfig, (PyObject *) NULL, __pyx_mstate_global->__pyx_n_u_Brass_QC_apps, (PyObject *) NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 4, __pyx_L1_error)
 ...
 *     name = 'Brass_QC'             # <<<<<<<<<<<<<<
*/
  if (__Pyx_SetNameInClass(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_name_2, __pyx_mstate_global->__pyx_n_u_Brass_QC) < (0)) __PYX_ERR(0, 6, __pyx_L1_error)
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init Brass_QC.apps", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init Brass_QC.apps");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{29},{9},{13},{8},{13},{18},{18},{11},{7},{8},{13},{10},{15},{8},{4},{11},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (190 bytes) */
const char* const cstring = "BZh91AY&SY\336\326\022\"\000\000\003_\200@\000\000\001\000\000\271\000 \000\277\277\376\0000\000\272\310h\241\223\324i\350j\001\247\244\022\246\2324\236\251\247\222<\243\023ja\212\215\244\3654h\001\220\034\237(\353\030\345\255\211\224\305ty\t\"P@\372\201\207p\335$\213\006\210\267\000 \363\217\327\201XT*\023\330K\205jX\231$ux\351\344\261\212\356M\312\007\007\243.\264\257\241\234h!\233\276b^\226\251cSx\262\251\322\301>!a\035\326\343\032~1\262W\007G4\313\225\221g\304'%}\267\017\023\036\200\262\231\022W\017\273\321\004\317\361w$S\205\t\r\355a\" ";
    PyObject *data = __Pyx_DecompressString(cstring, 190, 2);
...
const char* const cstring = "x\332MMA\016\3030\010\373Q\2760\265\225v\357\013\020\r\264\312FC\226\220\377/IWi\034\014\006c\273\007\2750\036\352hs\247\022Kqs8\246j\372\014,4\245\264h\334\3031g,e\365\177\004\326\345\356\016S*^Bd\010\021,\243\347\r\375\233x\307*\006\330\334`\357v\277\254.\007 \365\320\352\304\366\323;\033z\351\206\235(U\3411e\005\216\226\003\217C\304\223oL\231\023\346\241\372T\224kY\330\356\\0.\r\277\343^Y\n";
...
const char* const bytes = ".?django.db.models.BigAutoFieldAppConfigBrassQcConfigBrass_QCBrass_QC.appscline_in_tracebackdefault_auto_fielddjango.apps__doc____main____metaclass____module____mro_entries____name__name__prepare____qualname__setdefault__test__";
    PyObject *data = NULL;
