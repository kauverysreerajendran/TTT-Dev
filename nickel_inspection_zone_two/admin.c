...
{
    "distutils": {
        "name": "nickel_inspection_zone_two.admin",
        "sources": [
            ".\\nickel_inspection_zone_two\\admin.py"
        ]
    },
    "module_name": "nickel_inspection_zone_two.admin"
}
END: Cython Metadata */
...
#define __PYX_HAVE__nickel_inspection_zone_two__admin
#define __PYX_HAVE_API__nickel_inspection_zone_two__admin
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
static const char* const __pyx_f[] = {
  "nickel_inspection_zone_two/admin.py",
};
...
/* Module declarations from "nickel_inspection_zone_two.admin" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "nickel_inspection_zone_two.admin"
extern int __pyx_module_is_main_nickel_inspection_zone_two__admin;
int __pyx_module_is_main_nickel_inspection_zone_two__admin = 0;

/* Implementation of "nickel_inspection_zone_two.admin" */
...
__Pyx_RefNannySetupContext("PyInit_admin", 0);
  ...
  if (__pyx_module_is_main_nickel_inspection_zone_two__admin) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "nickel_inspection_zone_two.admin")) {
      if (unlikely((PyDict_SetItemString(modules, "nickel_inspection_zone_two.admin", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "nickel_inspection_zone_two/admin.py":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init nickel_inspection_zone_two.admin", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init nickel_inspection_zone_two.admin");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{5},{18},{14},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (79 bytes) */
const char* const cstring = "x\332%\211\321\r\2000\010\0057\352\n\216B(\240A\201\306\226\356o\325\367qw\311+\033\262k\220i\010h@v$\251H\027\237\030G+\324\"\273V\000\307\365\256y\343i\362V\240\177\276'\332\337C\222e\307i\t\2202\026\037\377D%\306";
...
const char* const bytes = ".?admincline_in_tracebackdjango.contrib__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
