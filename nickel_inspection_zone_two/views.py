...
def nq_zone_get_rejection_details(request):
...
def nq_zone_delink_selected_trays(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            print(f"❌ Error in nq_zone_delink_selected_trays: {str(e)}")
...
class NQ_Zone_HoldUnholdReasonAPIView(APIView):
...
class NQ_Zone_SaveIPCheckboxView(APIView):
...
class NQ_Zone_SaveIPPickRemarkAPIView(APIView):
...
def nq_zone_get_tray_capacity_for_lot(request):
    ...
    try:
        ...
        print(f"🔍 [nq_zone_get_tray_capacity_for_lot] Getting tray capacity for lot_id: {lot_id}")
        ...
        print(f"❌ [nq_zone_get_tray_capacity_for_lot] Error: {e}")
...
class NQ_Zone_DeleteBatchAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            print(f"🔍 [NQ_Zone_DeleteBatchAPIView] Deleting stock lot with ID: {stock_lot_id}")
...
class NQ_Zone_TrayDelinkTopTrayCalcAPIView(APIView):
...
class NQ_Zone_TrayDelinkAndTopTrayUpdateAPIView(APIView):
...
class NQ_Zone_ValidateTrayIdAPIView(APIView):
...
class NQ_Zone_Accepted_form(APIView):
    ...
    def post(self, request, format=None):
        ...
        print("STEP 1: Received POST request for NQ_Zone_Accepted_form")
...
class NQ_Zone_BatchRejectionAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            print(f"🔍 [NQ_Zone_BatchRejectionAPIView] Searching for JigUnloadAfterTable record...")
            ...
            if jig_unload_record:
                ...
                print(f"✅ Found by direct lot_id match")


                print(f"unload_lot_id: '{unload_lot_id}'")


                print(f"original_lot_ids: {original_lot_ids}")
                ...
                print(f"🔍 Not found by direct match, searching in combine_lot_ids...")
                ...
                for record in jig_unload_records:
                    ...
                    if record.combine_lot_ids and isinstance(record.combine_lot_ids, list):
                        ...
                        if lot_id in record.combine_lot_ids:
                            ...
                            print(f"✅ Found in combine_lot_ids")
            ...
            if missing_qty > 0 and delink_tray_ids:
                ...
                print(f"[NQ ZONE BATCH REJECTION DELINK] Processing {len(delink_tray_ids)} delink trays for missing qty: {missing_qty}")
                ...
                for delink_tray_id in delink_tray_ids:
                    ...
                    print(f"[NQ ZONE BATCH REJECTION DELINK] Processing tray: {delink_tray_id}")
                    ...
                    if nickel_delink_tray_obj:
                        ...
                        nickel_delink_tray_obj.batch_id = None
                    ...
                    jig_delink_tray_obj = JigUnload_TrayId.objects.filter(tray_id=delink_tray_id, lot_id=unload_lot_id).first()


                    if jig_delink_tray_obj:


                        jig_delink_tray_obj.delink_tray = True


                        jig_delink_tray_obj.save(update_fields=['delink_tray'])


                        print(f"✅ Delinked JigUnload_TrayId tray: {delink_tray_id}")
                ...
                if top_tray_id and top_tray_qty is not None:
                    ...
                    print(f"[NQ ZONE BATCH REJECTION TOP TRAY] Updating tray: {top_tray_id} with qty: {top_tray_qty}")
                    ...
                    top_tray_obj = NickelQcTrayId.objects.filter(tray_id=top_tray_id, lot_id=unload_lot_id).first()
                ...
                other_trays_nickel = NickelQcTrayId.objects.filter(
                ...
                for tray in other_trays_nickel:


                    print(f"[NQ ZONE BATCH REJECTION OTHER TRAY] Resetting NickelQcTrayId {tray.tray_id} to full capacity: {tray.tray_capacity}")
                ...
                print(f"[NQ ZONE BATCH REJECTION DELINK SUMMARY] Delinked {delinked_count} trays, reset {other_trays_count} other trays")
            ...
            print(f"✅ [NQ_Zone_BatchRejectionAPIView] Updated JigUnloadAfterTable record ID {jig_unload_record.id}")
            ...
            # Update NickelQcTrayId records (only for non-delinked trays)
            ...
            print(f"✅ [NQ_Zone_BatchRejectionAPIView] Updated {updated_unload_trays_count} NickelQcTrayId records")
            ...
            print(f"✅ [NQ_Zone_BatchRejectionAPIView] Created Nickel_QC_Rejection_ReasonStore record ID {rejection_record.id}")


            print(f"🔍 [NQ_Zone_BatchRejectionAPIView] === REJECTION END ===")
            ...
            print(f"❌ [NQ_Zone_BatchRejectionAPIView] JSON Decode Error: {e}")
            ...
            print(f"❌ [NQ_Zone_BatchRejectionAPIView] Unexpected Error: {str(e)}")


            import traceback


            print(f"❌ [NQ_Zone_BatchRejectionAPIView] Traceback: {traceback.format_exc()}")
...
class NQ_Zone_TrayRejectionAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            print(f"🔍 [NQ_Zone_TrayRejectionAPIView] === TRAY REJECTION START ===")


            print(f"🔍 [NQ_Zone_TrayRejectionAPIView] Received lot_id: {lot_id}")


            print(f"🔍 [NQ_Zone_TrayRejectionAPIView] Received batch_id: {batch_id}")


            print(f"🔍 [NQ_Zone_TrayRejectionAPIView] Received tray_rejections: {tray_rejections}")
            ...
            print(f"🔍 [NQ_Zone_TrayRejectionAPIView] Searching for JigUnloadAfterTable record...")
            ...
            if jig_unload_record:
                ...
                print(f"🔍 [NQ_Zone_TrayRejectionAPIView] Not found by direct match, searching in combine_lot_ids...")
            ...
            if not jig_unload_record:
                ...
                print(f"❌ [NQ_Zone_TrayRejectionAPIView] No JigUnloadAfterTable record found for lot_id: {lot_id}")
            ...
            print(f"🔍 [NQ_Zone_TrayRejectionAPIView] Available quantity from JigUnloadAfterTable: {available_qty}")
            ...
            print(f"🔍 [NQ_Zone_TrayRejectionAPIView] Processing {len(tray_rejections)} individual tray rejections...")
            ...
            for idx, item in enumerate(tray_rejections):
                ...
                print(f"🔍 [NQ_Zone_TrayRejectionAPIView] Processing rejection {idx + 1}:")
            ...
            print(f"🔍 [NQ_Zone_TrayRejectionAPIView] Updating TrayId records for {len(unique_tray_ids)} unique trays: {unique_tray_ids}")
            ...
            for tray_id in unique_tray_ids:
                ...
                if jig_tray_obj or tray_obj:
                    ...
                    print(f"🔍 [NQ_Zone_TrayRejectionAPIView] Updating tray {tray_id}: total_qty={tray_total_qty}")
                    ...
                    if tray_obj:
                        ...
                        if is_new_tray:
                            ...
                            print(f"✅ [NQ_Zone_TrayRejectionAPIView] Updated NEW TrayId {tray_id}: lot_id={main_original_lot_id}")
                            ...
                            print(f"✅ [NQ_Zone_TrayRejectionAPIView] Updated EXISTING TrayId {tray_id}")
                    ...
                    if nickel_qc_tray_obj:
                        ...
                        print(f"✅ [NQ_Zone_TrayRejectionAPIView] Updated NickelQcTrayId for tray {tray_id}: tray_quantity={tray_total_qty}, rejected_tray=True")
                        ...
                        print(f"➕ [NQ_Zone_TrayRejectionAPIView] Created new NickelQcTrayId for tray_id={tray_id} (NEW TRAY), tray_quantity={tray_total_qty}")
                    ...
                    print(f"⚠️ [NQ_Zone_TrayRejectionAPIView] Tray {tray_id} not found in any tray table")


            


            print(f"✅ [NQ_Zone_TrayRejectionAPIView] Updated {updated_tray_count} tray IDs as rejected")
            ...
            print(f"✅ [NQ_Zone_TrayRejectionAPIView] Updated JigUnloadAfterTable record ID {jig_unload_record.id}")


            


            print(f"🔍 [NQ_Zone_TrayRejectionAPIView] === TRAY REJECTION END ===")
            ...
            print(f"❌ [NQ_Zone_TrayRejectionAPIView] JSON Decode Error: {e}")
            ...
            print(f"❌ [NQ_Zone_TrayRejectionAPIView] Unexpected Error: {str(e)}")
...
def nq_zone_reject_check_tray_id(request):
    ...
    try:
        ...
        is_new_tray = not tray_obj.lot_id or tray_obj.lot_id == ''        
...
def nq_zone_reject_check_tray_id_simple(request):
    ...
    try:
        ...
        # ✅ Check if rejected in JigUnload_TrayId
...
def get_nickel_qc_tray_capacity_for_lot(unload_lot_id):
    ...
    try:
        ...
        if jig_unload_record and jig_unload_record.tray_type:
            ...
            # ✅ FIX: Import from Inprocess_Inspection.models (already imported at top)
...
def nq_zone_get_delink_tray_data(request):
    ...
    try:
        ...
        print(f"🔍 [nq_zone_get_delink_tray_data] Processing lot_id: {lot_id}")
        ...
        print(f"🔍 [nq_zone_get_delink_tray_data] Using unload_lot_id: {unload_lot_id}")
        ...
        print(f"🔍 [nq_zone_get_delink_tray_data] Original distribution: {original_distribution}")
        ...
        if not original_distribution:
            ...
            print("❌ [nq_zone_get_delink_tray_data] No original distribution found")
        ...
        if not rejections.exists():
            ...
            print("ℹ️ [nq_zone_get_delink_tray_data] No rejections found - no delink needed")
        ...
        print(f"🔍 [nq_zone_get_delink_tray_data] Found {rejections.count()} rejections")
        ...
        print(f"🔍 [nq_zone_get_delink_tray_data] Current distribution after rejections: {current_distribution}")
        ...
        print(f"🔍 [nq_zone_get_delink_tray_data] Empty tray positions needing delink: {empty_tray_positions}")


        print(f"🔍 [nq_zone_get_delink_tray_data] Total NEW trays needing delink: {len(delink_trays)}")
        ...
        if len(delink_trays) == 0:
            ...
            print("ℹ️ [nq_zone_get_delink_tray_data] No NEW trays became completely empty - no delink needed")
        ...
        print(f"❌ [nq_zone_get_delink_tray_data] Error: {e}")
...
def nq_zone_delink_check_tray_id(request):
    ...
    try:
        ...
        print(f"❌ [nq_zone_delink_check_tray_id] Error: {e}")
...
def nq_zone_get_accepted_tray_scan_data(request):
    ...
    try:
        ...
        print(f"🔍 [nq_zone_get_accepted_tray_scan_data] nq_physical_qty = {nq_physical_qty}")


        print(f"🔍 [nq_zone_get_accepted_tray_scan_data] total_rejection_qty = {total_rejection_qty}")


        print(f"🔍 [nq_zone_get_accepted_tray_scan_data] available_qty = {available_qty}")
        ...
        if is_delink_only_case:
            ...
            print(f"🚨 [nq_zone_get_accepted_tray_scan_data] Delink-only case detected: all pieces rejected")
        ...
        print(f"📊 [nq_zone_get_accepted_tray_scan_data] Tray calculation: {available_qty} qty = {full_trays} full trays + {top_tray_qty} top tray")
...
def nq_zone_save_single_top_tray_scan(request):
    ...
    try:
        ...
        print(f"🔍 [nq_zone_save_single_top_tray_scan] Received data:")
        ...
        if not draft_save:
            ...
            if tray_id:
                ...
                if top_tray_obj:
                    ...
                    print(f"✅ [nq_zone_save_single_top_tray_scan] Updated top tray: {tray_id}")
...
def nq_zone_get_top_tray_scan_draft(request):
...
def nq_zone_view_tray_list(request):
...
class NQ_Zone_TrayValidateAPIView(APIView):
        ...
        try:
            ...
            return JsonResponse({
                ...
                'debug_info': {
                    ...
                    'error_location': 'NQ_Zone_TrayValidateAPIView'
...
def nq_zone_save_accepted_tray_scan(request):
...
def nq_zone_check_tray_id(request):
...
def nq_zone_get_rejected_tray_scan_data(request):
...
class NQ_Zone_BatchRejectionDraftAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            print(f"🔍 [NQ_Zone_BatchRejectionDraftAPIView] Searching for JigUnloadAfterTable record...")
...
class NQ_Zone_TrayRejectionDraftAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            # 🔥 NEW: Find the unload_lot_id for Zone 2
...
def nq_zone_get_draft_data(request):
...
def nq_zone_get_all_drafts(request):


    """Get all draft data for a lot_id in Zone 2"""
    ...
    """Get all draft data for a lot_id in Nickel QC Zone 2"""
...
class NQ_Zone_PickTrayValidate_Complete_APIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            print(f"[NQ_Zone_PickTrayValidate_Complete_APIView] Checking tray_id '{tray_id}' for lot_id '{lot_id}'")
            ...
            print(f"[NQ_Zone_PickTrayValidate_Complete_APIView] Error: {str(e)}")
...
class NQ_Zone_PickTrayIdList_Complete_APIView(APIView):
    ...
    def get(self, request):
        ...
        print(f"🔍 [NQ_Zone_PickTrayIdList_Complete_APIView] Received lot_id: {lot_id}")
...
class NQ_Zone_TrayValidate_Complete_APIView(APIView):
...
class NQ_Zone_TrayIdList_Complete_APIView(APIView):
...
@csrf_exempt
def autosave_nickel_qc_zone_two(request):
    if request.method != 'POST':
    ...
    try:
        ...
        Nickel_QC_AutoSave.objects.create(
            lot_id=lot_id,
            user=request.user,
...
@csrf_exempt
def load_autosave_nickel_qc_zone_two(request, lot_id):
    try:
...
@csrf_exempt
def clear_autosave_nickel_qc_zone_two(request, lot_id):
    try:
        Nickel_QC_AutoSave.objects.filter(lot_id=lot_id).delete()
