...
{
    "distutils": {
        "name": "nickel_inspection_zone_two.tests",
        "sources": [
            ".\\nickel_inspection_zone_two\\tests.py"
        ]
    },
    "module_name": "nickel_inspection_zone_two.tests"
}
END: Cython Metadata */
...
#define __PYX_HAVE__nickel_inspection_zone_two__tests
#define __PYX_HAVE_API__nickel_inspection_zone_two__tests
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
static const char* const __pyx_f[] = {
  "nickel_inspection_zone_two/tests.py",
};
...
/* Module declarations from "nickel_inspection_zone_two.tests" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "nickel_inspection_zone_two.tests"
extern int __pyx_module_is_main_nickel_inspection_zone_two__tests;
int __pyx_module_is_main_nickel_inspection_zone_two__tests = 0;

/* Implementation of "nickel_inspection_zone_two.tests" */
...
#define __pyx_n_u_TestCase __pyx_string_tab[2]
...
__Pyx_RefNannySetupContext("PyInit_tests", 0);
  ...
  if (__pyx_module_is_main_nickel_inspection_zone_two__tests) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "nickel_inspection_zone_two.tests")) {
      if (unlikely((PyDict_SetItemString(modules, "nickel_inspection_zone_two.tests", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "nickel_inspection_zone_two/tests.py":1
 * from django.test import TestCase             # <<<<<<<<<<<<<<
 * 
 * # Create your tests here.
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_TestCase};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_django_test, __pyx_imported_names, 1, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init nickel_inspection_zone_two.tests", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init nickel_inspection_zone_two.tests");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{8},{18},{11},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (81 bytes) */
const char* const cstring = "x\332%\213A\016\200 \014\004\177\304\027<\370\005\356\315\n\325\240\245D)\377\267\312^v\222\235\rK\344n+:')\312T\224\354A\342\r\351\312'\364h\301\\ \252\360\311S[\036\302\037)\352\337\367\200L\356l\231w\014q\177\276^\364~%\250";
...
const char* const bytes = ".?TestCasecline_in_tracebackdjango.test__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
