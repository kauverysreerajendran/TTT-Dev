...
{
    "distutils": {
        "name": "nickel_audit_zone_two.apps",
        "sources": [
            ".\\nickel_audit_zone_two\\apps.py"
        ]
    },
    "module_name": "nickel_audit_zone_two.apps"
}
END: Cython Metadata */
...
#define __PYX_HAVE__nickel_audit_zone_two__apps
#define __PYX_HAVE_API__nickel_audit_zone_two__apps
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "nickel_audit_zone_two.apps" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "nickel_audit_zone_two.apps"
extern int __pyx_module_is_main_nickel_audit_zone_two__apps;
int __pyx_module_is_main_nickel_audit_zone_two__apps = 0;

/* Implementation of "nickel_audit_zone_two.apps" */
...
#define __pyx_n_u_NickelAuditZoneTwoConfig __pyx_string_tab[4]
...
#define __pyx_n_u_nickel_audit_zone_two __pyx_string_tab[15]
#define __pyx_n_u_nickel_audit_zone_two_apps __pyx_string_tab[16]
...
__Pyx_RefNannySetupContext("PyInit_apps", 0);
  ...
  if (__pyx_module_is_main_nickel_audit_zone_two__apps) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "nickel_audit_zone_two.apps")) {
      if (unlikely((PyDict_SetItemString(modules, "nickel_audit_zone_two.apps", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "nickel_audit_zone_two/apps.py":1
...
*/
  ...
  /* "nickel_audit_zone_two/apps.py":4
 * 
 * 
 * class NickelAuditZoneTwoConfig(AppConfig):             # <<<<<<<<<<<<<<
 *     default_auto_field = 'django.db.models.BigAutoField'
 *     name = 'nickel_audit_zone_two'
*/
  ...
  __pyx_t_6 = __Pyx_Py3MetaclassPrepare(__pyx_t_5, __pyx_t_2, __pyx_mstate_global->__pyx_n_u_NickelAuditZoneTwoConfig, __pyx_mstate_global->__pyx_n_u_NickelAuditZoneTwoConfig, (PyObject *) NULL, __pyx_mstate_global->__pyx_n_u_nickel_audit_zone_two_apps, (PyObject *) NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 4, __pyx_L1_error)
  ...
  /* "nickel_audit_zone_two/apps.py":5
 * 
 * class NickelAuditZoneTwoConfig(AppConfig):
 *     default_auto_field = 'django.db.models.BigAutoField'             # <<<<<<<<<<<<<<
 *     name = 'nickel_audit_zone_two'
*/
  ...
  /* "nickel_audit_zone_two/apps.py":6
 * class NickelAuditZoneTwoConfig(AppConfig):
 *     default_auto_field = 'django.db.models.BigAutoField'
 *     name = 'nickel_audit_zone_two'             # <<<<<<<<<<<<<<
*/
  if (__Pyx_SetNameInClass(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_name_2, __pyx_mstate_global->__pyx_n_u_nickel_audit_zone_two) < (0)) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 *     name = 'nickel_audit_zone_two'
*/
  __pyx_t_4 = __Pyx_Py3ClassCreate(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_NickelAuditZoneTwoConfig, __pyx_t_2, __pyx_t_6, NULL, 0, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_4);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_NickelAuditZoneTwoConfig, __pyx_t_4) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init nickel_audit_zone_two.apps", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init nickel_audit_zone_two.apps");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{29},{9},{24},{18},{18},{11},{7},{8},{13},{10},{15},{8},{4},{21},{26},{11},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (213 bytes) */
const char* const cstring = "BZh91AY&SY\246j\322c\000\000\003_\200@\000\000\001\000\000\271\001\004\020\277\277\376\2200\000\272\230h\243C\324\323'\250h\006\322\001\252~\212zF\206\203@\r\r\004\246\2414\323S\324\315#j\031\250\320\2337\275\333<+\347g\361\021\373|\233\014\220\326\2750I$\260\230\243\"\016\010\270p\244jo-&\n\026\030\t\203\3168\3141\034\221\346\264\271I\373\301\331$\264\025\226\310M\264\035\206X\302\220\266\244fE\221t_i\360\342\322\256lT(\311\035\335\027\274\335\354\254\215\005,\266\202\010\212G\217\251Z\253;\034\37691\274\371\352i\003ZAR\334\272{\n\352X\263\202\005\r\240<\2218<D\2040\231p\374]\311\024\341BB\231\253I\214";
    PyObject *data = __Pyx_DecompressString(cstring, 213, 2);
...
const char* const cstring = "x\332m\216=\016\3020\014\205o\224+\240\202\304\310\304\304b\271\211[\205\272vH\034!qz\322\264lx\360\257\374\275\347N\341\2112\253\013\243[5\020\027w\216\363PM\257\2218\014)]T\2468\337\242_\210\207\032\242=T\350\376\326}\3579\nA\024\260\214\236F\364K\240\t+\033`c\300\264A\016\005L\251\000\004\365\320b\305\366\263U2\364\214\245\364ACe\352]V \261\034\251\037\004W\332\263t\037\r\336\214\300\2479\001{\353\337\345\241\2272%\314\035\372\252\310;\251\220\375l\202Qi\371\013\212\212i\"";
    ...
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (264 bytes) */
const char* const bytes = ".?django.db.models.BigAutoFieldAppConfigNickelAuditZoneTwoConfigcline_in_tracebackdefault_auto_fielddjango.apps__doc____main____metaclass____module____mro_entries____name__namenickel_audit_zone_twonickel_audit_zone_two.apps__prepare____qualname__setdefault__test__";
    PyObject *data = NULL;
