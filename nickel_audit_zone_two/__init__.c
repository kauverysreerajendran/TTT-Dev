...
{
    "distutils": {
        "name": "nickel_audit_zone_two.__init__",
        "sources": [
            ".\\nickel_audit_zone_two\\__init__.py"
        ]
    },
    "module_name": "nickel_audit_zone_two.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__nickel_audit_zone_two
#define __PYX_HAVE_API__nickel_audit_zone_two
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
static const char* const __pyx_f[] = {
  "nickel_audit_zone_two/__init__.py",
};
...
/* Module declarations from "nickel_audit_zone_two" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "nickel_audit_zone_two.__init__"
extern int __pyx_module_is_main_nickel_audit_zone_two____init__;
int __pyx_module_is_main_nickel_audit_zone_two____init__ = 0;

/* Implementation of "nickel_audit_zone_two" */
...
#define __pyx_kp_u_nickel_audit_zone_two___init __pyx_string_tab[1]
...
static int __pyx_pymod_exec_nickel_audit_zone_two(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_nickel_audit_zone_two},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_nickel_audit_zone_two(void) CYTHON_SMALL_CODE; /*proto*/
#if !defined(CYTHON_NO_PYINIT_EXPORT) && (defined(_WIN32) || defined(WIN32) || defined(MS_WINDOWS))
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_nickel_audit_zone_two(); }
#endif
__Pyx_PyMODINIT_FUNC PyInit_nickel_audit_zone_two(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_nickel_audit_zone_two(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'nickel_audit_zone_two' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "nickel_audit_zone_two" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_nickel_audit_zone_two", 0);
  ...
  if (__pyx_module_is_main_nickel_audit_zone_two____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_nickel_audit_zone_two___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "nickel_audit_zone_two")) {
      if (unlikely((PyDict_SetItemString(modules, "nickel_audit_zone_two", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "nickel_audit_zone_two/__init__.py":1
             # <<<<<<<<<<<<<<
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init nickel_audit_zone_two", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init nickel_audit_zone_two");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{30},{18},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (86 bytes) */
const char* const cstring = "x\332%\214Q\n\2000\014Co\344\025<J\250[\205\262\256C\327\"xz\253\346#y\311GV\223\322XAQ\305q\017c\3705\026@,;\212J.b\360\223\noT\032\320){\252\217\032\312/\031\365/\217 \375y\262W\336)4?\234g\372\003\257\236*\033";
    ...
    #endif
    #else /* compression: none (105 bytes) */
const char* const bytes = "?nickel_audit_zone_two.__init__cline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
