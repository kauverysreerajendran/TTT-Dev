...
{
    "distutils": {
        "name": "nickel_audit_zone_two.tests",
        "sources": [
            ".\\nickel_audit_zone_two\\tests.py"
        ]
    },
    "module_name": "nickel_audit_zone_two.tests"
}
END: Cython Metadata */
...
#define __PYX_HAVE__nickel_audit_zone_two__tests
#define __PYX_HAVE_API__nickel_audit_zone_two__tests
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
static const char* const __pyx_f[] = {
  "nickel_audit_zone_two/tests.py",
};
...
/* Module declarations from "nickel_audit_zone_two.tests" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "nickel_audit_zone_two.tests"
extern int __pyx_module_is_main_nickel_audit_zone_two__tests;
int __pyx_module_is_main_nickel_audit_zone_two__tests = 0;

/* Implementation of "nickel_audit_zone_two.tests" */
...
__Pyx_RefNannySetupContext("PyInit_tests", 0);
  ...
  if (__pyx_module_is_main_nickel_audit_zone_two__tests) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "nickel_audit_zone_two.tests")) {
      if (unlikely((PyDict_SetItemString(modules, "nickel_audit_zone_two.tests", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "nickel_audit_zone_two/tests.py":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init nickel_audit_zone_two.tests", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init nickel_audit_zone_two.tests");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
