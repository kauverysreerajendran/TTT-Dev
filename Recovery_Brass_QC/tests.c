...
{
    "distutils": {
        "name": "Recovery_Brass_QC.tests",
        "sources": [
            ".\\Recovery_Brass_QC\\tests.py"
        ]
    },
    "module_name": "Recovery_Brass_QC.tests"
}
END: Cython Metadata */
...
#define __PYX_HAVE__Recovery_Brass_QC__tests
#define __PYX_HAVE_API__Recovery_Brass_QC__tests
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "Recovery_Brass_QC.tests" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "Recovery_Brass_QC.tests"
extern int __pyx_module_is_main_Recovery_Brass_QC__tests;
int __pyx_module_is_main_Recovery_Brass_QC__tests = 0;

/* Implementation of "Recovery_Brass_QC.tests" */
...
__Pyx_RefNannySetupContext("PyInit_tests", 0);
  ...
  if (__pyx_module_is_main_Recovery_Brass_QC__tests) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Recovery_Brass_QC.tests")) {
      if (unlikely((PyDict_SetItemString(modules, "Recovery_Brass_QC.tests", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init Recovery_Brass_QC.tests", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init Recovery_Brass_QC.tests");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
