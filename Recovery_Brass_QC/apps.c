...
{
    "distutils": {
        "name": "Recovery_Brass_QC.apps",
        "sources": [
            ".\\Recovery_Brass_QC\\apps.py"
        ]
    },
    "module_name": "Recovery_Brass_QC.apps"
}
END: Cython Metadata */
...
#define __PYX_HAVE__Recovery_Brass_QC__apps
#define __PYX_HAVE_API__Recovery_Brass_QC__apps
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "Recovery_Brass_QC.apps" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "Recovery_Brass_QC.apps"
extern int __pyx_module_is_main_Recovery_Brass_QC__apps;
int __pyx_module_is_main_Recovery_Brass_QC__apps = 0;

/* Implementation of "Recovery_Brass_QC.apps" */
...
#define __pyx_n_u_RecoveryBrassQcConfig __pyx_string_tab[4]
#define __pyx_n_u_Recovery_Brass_QC __pyx_string_tab[5]
#define __pyx_n_u_Recovery_Brass_QC_apps __pyx_string_tab[6]
...
__Pyx_RefNannySetupContext("PyInit_apps", 0);
  ...
  if (__pyx_module_is_main_Recovery_Brass_QC__apps) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Recovery_Brass_QC.apps")) {
      if (unlikely((PyDict_SetItemString(modules, "Recovery_Brass_QC.apps", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  /* "Recovery_Brass_QC/apps.py":4
 * 
 * 
 * class RecoveryBrassQcConfig(AppConfig):             # <<<<<<<<<<<<<<
 *     default_auto_field = 'django.db.models.BigAutoField'
 *     name = 'Recovery_Brass_QC'
*/
  ...
  __pyx_t_6 = __Pyx_Py3MetaclassPrepare(__pyx_t_5, __pyx_t_2, __pyx_mstate_global->__pyx_n_u_RecoveryBrassQcConfig, __pyx_mstate_global->__pyx_n_u_RecoveryBrassQcConfig, (PyObject *) NULL, __pyx_mstate_global->__pyx_n_u_Recovery_Brass_QC_apps, (PyObject *) NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 4, __pyx_L1_error)
...
*/
  ...
  /* "Recovery_Brass_QC/apps.py":6
 * class RecoveryBrassQcConfig(AppConfig):
 *     default_auto_field = 'django.db.models.BigAutoField'
 *     name = 'Recovery_Brass_QC'             # <<<<<<<<<<<<<<
*/
  if (__Pyx_SetNameInClass(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_name_2, __pyx_mstate_global->__pyx_n_u_Recovery_Brass_QC) < (0)) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 *     name = 'Recovery_Brass_QC'
*/
  __pyx_t_4 = __Pyx_Py3ClassCreate(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_RecoveryBrassQcConfig, __pyx_t_2, __pyx_t_6, NULL, 0, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_4);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_RecoveryBrassQcConfig, __pyx_t_4) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init Recovery_Brass_QC.apps", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init Recovery_Brass_QC.apps");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{29},{9},{21},{17},{22},{18},{18},{11},{7},{8},{13},{10},{15},{8},{4},{11},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (207 bytes) */
const char* const cstring = "BZh91AY&SY\245\006\352\356\000\000\003_\200@\000\000\001\000\000\271\0000\000\277\277\377 0\000\272A\244jbz\247\352\236\246\364\243\365LG\246Pc\000\004\300\000L\030\243H\364\211\262M\250\365\014\232i2x\366\353L+\264:qA\276\323a\233\346\242K\206\020\007\224\016<7\224\2222\022@q\002X\332}fEq`\332\226.\025\352\373\\\255\241j\260lQ9S\235|\225\237\242A\201\004\247\342\322\250\314(\242e\001\227\355\230\207\243x\014\024s\031\231\214\031+\241@\2478\370\030\007\372-U\245\207\"\247w\375\220\243\n\345c&\216Nu\270\020\220\236 E\244 \032\301_\255\\QX\354\177\213\271\"\234(HR\203uw\000";
    PyObject *data = __Pyx_DecompressString(cstring, 207, 2);
...
const char* const cstring = "x\332eN[\016\3020\014\273Q\257\200\266I\374\217\013DY\353M\205\256)} q\373\265\205} \362\341$\216\023G]\314\235\375&\312,j\027\003\227\324h\267\241d\271Z83\2040\211_\355v\203\226\027\342{\214\234\322\254\177I\352,\315\323\037\2418\204\244\235\365 \353)G\326XX?\014V..\023W\037Z\233\321\367\213&'2\242\251\306\316u\247ed\326\256\035l\215\230\342\320\253(\004\237\243E\037x\336qb\210\010\034\273\352Y\330}\310\204|\372RF\252x\000\264\033c\265";
...
const char* const bytes = ".?django.db.models.BigAutoFieldAppConfigRecoveryBrassQcConfigRecovery_Brass_QCRecovery_Brass_QC.appscline_in_tracebackdefault_auto_fielddjango.apps__doc____main____metaclass____module____mro_entries____name__name__prepare____qualname__setdefault__test__";
    PyObject *data = NULL;
