...
urlpatterns = [
    ...
    # Jig Tracking APIs
    path('update_jig_tracking/', views.JigTrackingUpdateAPIView.as_view(), name='update_jig_tracking'),
    path('check_jig_tracking_status/', views.JigTrackingStatusAPIView.as_view(), name='check_jig_tracking_status'),
]