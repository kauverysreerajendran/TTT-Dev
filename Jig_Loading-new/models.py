...
class Jig(models.Model):
    ...
    batch_id = models.CharField(max_length=100, null=True, blank=True, help_text="Batch ID for which Jig is locked")  # <-- Add this line
...
class JigAutoSave(models.Model):
    ...
    batch_id = models.CharField(max_length=100, db_index=True)  # <-- Add this line!
