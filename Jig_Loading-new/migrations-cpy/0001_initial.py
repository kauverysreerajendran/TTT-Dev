    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('no_of_cycle_count', models.CharField(blank=True, default='-/-', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'indexes': [models.Index(fields=['user', 'lot_id', 'updated_at'], name='Jig_Loading_user_id_b2eefd_idx'), models.Index(fields=['session_key', 'lot_id', 'updated_at'], name='Jig_Loading_session_53c463_idx')],
                'constraints': [models.UniqueConstraint(condition=models.Q(('user__isnull', False)), fields=('user', 'lot_id'), name='unique_user_lot'), models.UniqueConstraint(condition=models.Q(('session_key__isnull', False)), fields=('session_key', 'lot_id'), name='unique_session_lot')],
            },
        ),
    ]
